...
Icon getIconsForTile(String categoryName) {
  switch (categoryName) {
    case 'Cloths':
      return const Icon(Icons.checkroom, color: Color(0xFFFF5733));
    case 'Coffee':
      return const Icon(Icons.coffee, color: Color(0xFF6F4F28));
    case 'Debt':
      return const Icon(Icons.monetization_on, color: Color(0xFF9C27B0));
    case 'Drinks':
      return const Icon(Icons.local_drink, color: Color(0xFF4CAF50));
    case 'Education':
      return const Icon(Icons.school, color: Color(0xFF2196F3));
    case 'Electricity':
      return const Icon(Icons.bolt, color: Color(0xFFFFEB3B));
    case 'Electronic':
      return const Icon(Icons.phone_android, color: Color(0xFF607D8B));
    case 'Entertainment':
      return const Icon(Icons.movie, color: Color(0xFFFFC107));
    case 'Food':
      return const Icon(Icons.fastfood, color: Color(0xFFFF9800));
    case 'Gas Bill':
      return const Icon(Icons.local_fire_department, color: Color(0xFFFF5722));
    case 'Groceries':
      return const Icon(Icons.shopping_cart, color: Color(0xFF4CAF50));
    case 'Healthcare':
      return const Icon(Icons.local_hospital, color: Color(0xFFF44336));
    case 'Internet':
      return const Icon(Icons.wifi, color: Color(0xFF03A9F4));
    case 'Personal':
      return const Icon(Icons.person, color: Color(0xFF9E9E9E));
    case 'Phone Bill':
      return const Icon(Icons.phone, color: Color(0xFF03A9F4));
    case 'Bell':
      return const Icon(Icons.notifications, color: Color(0xFFFFC107));
    case 'Rent':
      return const Icon(Icons.home, color: Color(0xFF8BC34A));
    case 'Restaurant':
      return const Icon(Icons.restaurant, color: Color(0xFF9C27B0));
    case 'Shopping':
      return const Icon(Icons.shopping_bag, color: Color(0xFFE91E63));
    case 'Spotify':
      return const Icon(Icons.music_note, color: Color(0xFF1DB954));
    case 'TV':
      return const Icon(Icons.tv, color: Color(0xFF8E24AA));
    case 'Transport':
      return const Icon(Icons.directions_car, color: Color(0xFFFF5722));
    case 'Travel':
      return const Icon(Icons.flight, color: Color(0xFF00BCD4));
    case 'Utilities':
      return const Icon(Icons.build, color: Color(0xFF9E9E9E));
    case 'Water':
      return const Icon(Icons.water_drop, color: Color(0xFF03A9F4));
    case 'YouTube':
      return const Icon(Icons.video_library, color: Color(0xFFFF0000));
    case 'Netflix':
      return const Icon(Icons.tv, color: Color(0xFFE50914));
    case 'Prime':
      return const Icon(Icons.shopping_cart, color: Color(0xFFFF9800));
    case 'Borrow':
      return const Icon(Icons.attach_money, color: Color(0xFFFFEB3B));
    case 'Dividend':
      return const Icon(Icons.show_chart, color: Color(0xFF4CAF50));
    case 'Freelance':
      return const Icon(Icons.laptop_mac, color: Color(0xFF2196F3));
    case 'Passive Income':
      return const Icon(Icons.attach_money, color: Color(0xFF9C27B0));
    case 'Pension':
      return const Icon(Icons.savings, color: Color(0xFF8BC34A));
    case 'Profit':
      return const Icon(Icons.show_chart, color: Color(0xFF00BCD4));
    case 'Salary':
      return const Icon(Icons.money_off, color: Color(0xFFFF9800));
    case 'Stock Trading':
      return const Icon(Icons.insert_chart, color: Color(0xFF673AB7));
    case 'Other':
      return const Icon(Icons.add_circle, color: Color(0xFF9E9E9E));
    default:
